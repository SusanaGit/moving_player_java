...
public class Villain extends Sprite {
    ...
    public void createDynamicVillainsBodiesFromMap(TiledMap map, World world) {
    ...
    private void createDynamicVillainBodyFromMap(MapObject villainObject, World world) {
